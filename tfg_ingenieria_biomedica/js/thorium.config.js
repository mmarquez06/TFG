...
/* -- Firebase Config */
const firebaseStoragePath="userprofiles";
...
try {
   var firebaseConfig = { 
        apiKey: "AIzaSyCTTsRvDzmM7LDYzlnSTaWoAxsflje2c4M",
  authDomain: "prueba-5eb0b.firebaseapp.com",
  databaseURL: "https://prueba-5eb0b-default-rtdb.firebaseio.com",
  projectId: "prueba-5eb0b",
  storageBucket: "prueba-5eb0b.appspot.com",
  messagingSenderId: "66549878299",
  appId: "1:66549878299:web:13e5e3e033b207f4f3f2be",
  measurementId: "G-LK1M7Z0RXZ"
    };
 } catch (error) {
   console.error(error);
...
{
    path: '/home/',
    url: './pages/home.html?r=75931',
    name: 'home',
},
{
    path: '/login/',
    url: './pages/login.html?r=39621',
    name: 'login',
},
{
    path: '/sign_up/',
    url: './pages/sign_up.html?r=84206',
    name: 'sign_up',
},
{
    path: '/index2/',
    url: './pages/index2.html?r=39790',
    name: 'index2',
},
{
    path: '(.*)',
...
var app = new Framework7({
    "version": "1.0.0",
    "id": "com.thorium.pawwheel_tracker",
    "root": "#app",
    "theme": theme,
    
    "language": "en",
    "routes": routes,
    "name": "PawWheel Tracker",
